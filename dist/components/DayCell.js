        ...
        if (startEdgeIndex > -1 && endEdgeIndex > -1) {
          ...
          if ((0, _isSameDay2.default)(inRanges[0].startDate, inRanges[1].startDate)) {
            ...
            if ((0, _isBefore2.default)(inRanges[0].endDate, inRanges[1].endDate)) {
              ...
              rightColor = (0, _getDay2.default)(inRanges[1].startDate) === 6 || (0, _isSameDay2.default)(inRanges[0].endDate, inRanges[1].endDate) ? 'transparent' : inRanges[0].color;
            }
          } else {
            ...
            if ((0, _isBefore2.default)(inRanges[1].endDate, inRanges[0].endDate)) {
              ...
              rightColor = (0, _getDay2.default)(inRanges[0].startDate) === 6 || (0, _isSameDay2.default)(inRanges[1].endDate, inRanges[0].endDate) ? 'transparent' : inRanges[1].color;
            }
          }
